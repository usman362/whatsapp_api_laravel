...
@section('title', 'Edit WhatsApp User')
...
<div class="max-w-2xl">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900">Edit WhatsApp User</h1>
    </div>

    <form method="POST" action="{{ route('admin.wa-users.update', $user) }}" class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-5">
        @csrf
        @method('PUT')
        ...
        <div>
            ...
            <input type="text" name="phone_e164" id="phone_e164" value="{{ old('phone_e164', $user->phone_e164) }}" required
        ...
        <div>
            ...
            <input type="url" name="api_base_url" id="api_base_url" value="{{ old('api_base_url', $user->api_base_url) }}" required
        ...
        <div>
            ...
            <input type="text" name="api_token" id="api_token" value="{{ old('api_token', $user->api_token) }}"
